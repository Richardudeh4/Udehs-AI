...
// const Navbar = () => {
//   return (
//     <div className='flex gap-5 justify-between items-center px-7 py-1 font-bold border-b border-solid border-zinc-100 leading-[154.4%] max-md:flex-wrap max-md:px-5'>
//         <div className='flex gap-1.5 justify-center self-stretch my-auto text-2xl tracking-tighter text-neutral-700'>
// <Image sizes='100vw' style={{ width: '100px', height: 'auto'}} width={0} height={0} src="/images/logo.png" alt="logo" />
//         </div>
